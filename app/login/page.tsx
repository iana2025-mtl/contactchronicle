      ...
      <main className="flex-1 container mx-auto px-4 py-8 flex items-center justify-center">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-lg shadow-lg border border-purple-200 p-8 bg-gradient-to-br from-white to-purple-50">
            <h1 className="text-3xl font-bold mb-2 text-purple-800 text-center">Welcome Back</h1>
            <p className="text-purple-600 text-center mb-6">Sign in to your account</p>
