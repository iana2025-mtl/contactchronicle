  ...
  return (
    <ProtectedRoute>
      ...
      <main className="flex-1 container mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8">
        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6 text-purple-800">Build Your Personal Timeline</h1>
        ...
        <div className="bg-gradient-to-r from-blue-100 to-purple-100 border border-purple-300 rounded-lg p-3 sm:p-4 mb-4 sm:mb-6 shadow-sm">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-2">
            <h2 className="text-xs sm:text-sm font-semibold text-purple-900">📝 How to Enter Your Job History:</h2>
            <button
              onClick={() => setShowResumeImport(!showResumeImport)}
              className="text-xs sm:text-sm bg-gradient-to-r from-purple-400 to-pink-400 text-white px-3 py-2 sm:py-1 rounded-lg hover:from-purple-500 hover:to-pink-500 transition-all shadow-sm self-start sm:self-auto"
            >
        ...
        <div className="bg-white rounded-lg shadow-sm border border-purple-200 p-3 sm:p-4 mb-4 sm:mb-6 bg-gradient-to-r from-white to-purple-50">
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            ...
            <div className="sm:w-48">
              <label className="block text-sm font-medium text-purple-700 mb-1.5">Filter by Type</label>
              <select
                value={filterType}
            ...
            filteredAndSortedEvents.map((event) => (
              ...
              >
                <div className="flex justify-between items-start mb-2">
                  <span className="text-sm font-medium text-purple-900">{event.monthYear}</span>
                </div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                ...
                filteredAndSortedEvents.map((event) => (
                  <tr 
                    ...
                    onClick={() => handleEdit(event)}
                  >
                    <td className="px-4 xl:px-6 py-4 whitespace-nowrap text-sm font-medium text-purple-900">{event.monthYear}</td>
                    ...
                    <td className="px-4 xl:px-6 py-4 text-sm text-purple-700">{event.personalEvent || <span className="text-purple-300">-</span>}</td>
                    <td className="px-4 xl:px-6 py-4 text-sm text-purple-700">{event.geographicEvent || <span className="text-purple-300">-</span>}</td>
                  </tr>
                ))
              )}
            </tbody>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-2 text-base border border-purple-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-400 bg-white resize-none"
                />
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                {editingEvent && (
                  <button
                    ...
                    className="flex-1 px-4 py-3 sm:py-2 bg-gradient-to-r from-pink-400 to-red-400 text-white rounded-lg hover:from-pink-500 hover:to-red-500 transition-all shadow-sm font-medium text-base sm:text-sm"
                  >
                    Delete
                  </button>
                )}
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 flex-wrap">
          <button
            ...
            className="flex-1 sm:flex-initial px-4 sm:px-6 py-3 bg-gradient-to-r from-purple-500 to-blue-500 text-white rounded-lg hover:from-purple-600 hover:to-blue-600 transition-all font-medium shadow-md text-sm sm:text-base"
          >
            Add, Edit, Delete Panel
          </button>
          <button
            onClick={handleConfirmTimeline}
            className="flex-1 sm:flex-initial px-4 sm:px-6 py-3 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-lg hover:from-pink-600 hover:to-purple-600 transition-all font-medium shadow-md text-sm sm:text-base"
          >
            Confirm Timeline
          </button>
          <button
